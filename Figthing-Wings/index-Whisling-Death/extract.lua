...
Utility script to build the index of proper names in Whistling Death scenarios
...
This program uses a text  file with a hard-coded name, F<list-WD.txt>.
This file contains  lines with a 1- or 2-letter  code, some space, and
then some data. These codes and the corresponding data are:

=over 4

=item  * S Scenario code: an  alphabetic code  plus the
scenario number, e.g. A029. In case of mission-scale scenarios,
