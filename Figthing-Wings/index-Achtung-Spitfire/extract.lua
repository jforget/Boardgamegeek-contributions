...
Utility script to build the index of proper names in Achtung Spitfire! scenarios
...
F<list-ASP.txt>. This file contains lines with a 1- or 2-letter code,
